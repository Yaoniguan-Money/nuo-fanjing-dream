...
结尾先做 cinematic reveal，再进入神龛式角色墙。Codex 固定八大职司：开路将军、先锋小姐、九位土地神、唐氏太婆、勾簿判官、扫地和尚、柳毅、阿布摩；同一面具只占一个位置，重复体验更新该位置最近一次结果。详情当前使用透明 PNG 与卡片式倾斜交互，正式模型接入前不得标注为文物扫描；结果页始终保留“历史身份及授权来源未提供”的声明。

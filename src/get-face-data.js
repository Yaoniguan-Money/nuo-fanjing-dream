(function (root) {
  ...
  root.NuoGetFaceData = {
    ...
    codex: {
      ...
      slots: [
        { id: "crown-beard", kind: "mask" },
        { id: "square-crown", kind: "mask" },
        { id: "bound-hair", kind: "mask" },
        { id: "high-crown", kind: "mask" },
        { id: "reserved-05", kind: "reserved" }, { id: "reserved-06", kind: "reserved" },
        { id: "reserved-07", kind: "reserved" }, { id: "reserved-08", kind: "reserved" },
        { id: "reserved-09", kind: "reserved" }, { id: "reserved-10", kind: "reserved" },
        { id: "reserved-11", kind: "reserved" }, { id: "reserved-12", kind: "reserved" }
      ],

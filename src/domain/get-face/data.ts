...
export const faceData: FaceData = {
  ...
  masks: [
    { id: "crown-beard", name: "翘冠长须", asset: "/dream-assets/masks/mask-01.png", artwork: { card: "/dream-assets/codex/masks/kailu-jiangjun/front.png" }, themes: ["前路", "选择", "未来", "迷茫", "卡住", "出发", "方向"], visual: { tint: "amber", pattern: "山纹", emblem: "路印", card: { primary: "#e2a81d", secondary: "#87c9e9", glyph: "mountain" }, relief: { depth: 0.34, resolution: 56, threshold: 24 } } },
    { id: "square-crown", name: "方冠笑相", asset: "/dream-assets/masks/mask-02.png", artwork: { card: "/dream-assets/codex/masks/xianfeng-xiaojie/front.png" }, themes: ["感情", "关系", "喜欢", "沟通", "和好", "家人", "朋友"], visual: { tint: "vermilion", pattern: "合纹", emblem: "结印", card: { primary: "#e4495a", secondary: "#f2bb50", glyph: "knot" }, relief: { depth: 0.30, resolution: 56, threshold: 24 } } },
    { id: "bound-hair", name: "束发圆目", asset: "/dream-assets/masks/mask-03.png", artwork: { card: "/dream-assets/codex/masks/yabing-tudi/front.png" }, themes: ["工作", "事业", "面试", "项目", "钱", "边界", "决定"], visual: { tint: "iron", pattern: "衡纹", emblem: "尺印", card: { primary: "#b284ff", secondary: "#5fa6d8", glyph: "scale" }, relief: { depth: 0.28, resolution: 56, threshold: 24 } } },
    { id: "high-crown", name: "高冠静相", asset: "/dream-assets/masks/mask-04.png", artwork: { card: "/dream-assets/codex/masks/tangshi-taipo/front.png" }, themes: ["害怕", "恐惧", "焦虑", "失去", "压力", "不安", "自己"], visual: { tint: "bone", pattern: "回纹", emblem: "灯印", card: { primary: "#7be4c7", secondary: "#a8e17e", glyph: "lamp" }, relief: { depth: 0.26, resolution: 56, threshold: 24 } } }
  ],
  story: [
  ...
  codex: {
    ...
    slots: [
      { id: "crown-beard", kind: "mask" }, { id: "square-crown", kind: "mask" }, { id: "bound-hair", kind: "mask" }, { id: "high-crown", kind: "mask" },
      { id: "reserved-05", kind: "reserved" }, { id: "reserved-06", kind: "reserved" }, { id: "reserved-07", kind: "reserved" }, { id: "reserved-08", kind: "reserved" },

...
export const faceData: FaceData = {
  ...
  masks: [
    { id: "crown-beard", name: "开路将军", asset: "/dream-assets/codex/masks/kailu-jiangjun/front.png", views: { front: "/dream-assets/codex/masks/kailu-jiangjun/front.png", side: "/dream-assets/codex/masks/kailu-jiangjun/side.png", back: "/dream-assets/codex/masks/kailu-jiangjun/back.png" }, artwork: { card: "/dream-assets/ui/codex/fronts/kailu-jiangjun-v2.png" }, themes: ["前路", "选择", "未来", "迷茫", "卡住", "出发", "方向"], visual: { tint: "amber", pattern: "山纹", emblem: "路印", card: { primary: "#c99b3d", secondary: "#89a99b", glyph: "mountain" }, relief: { depth: 0.34, resolution: 56, threshold: 24 } } },
    { id: "square-crown", name: "先锋小姐", asset: "/dream-assets/codex/masks/xianfeng-xiaojie/front.png", views: { front: "/dream-assets/codex/masks/xianfeng-xiaojie/front.png", side: "/dream-assets/codex/masks/xianfeng-xiaojie/side.png", back: "/dream-assets/codex/masks/xianfeng-xiaojie/back.png" }, artwork: { card: "/dream-assets/ui/codex/fronts/xianfeng-xiaojie-v2.png" }, themes: ["感情", "关系", "边界", "拒绝", "强迫", "压力", "自由"], visual: { tint: "vermilion", pattern: "合纹", emblem: "结印", card: { primary: "#c99b3d", secondary: "#a65c48", glyph: "knot" }, relief: { depth: 0.30, resolution: 56, threshold: 24 } } },
    { id: "bound-hair", name: "九位土地神", asset: "/dream-assets/codex/masks/yabing-tudi/front.png", views: { front: "/dream-assets/codex/masks/yabing-tudi/front.png", side: "/dream-assets/codex/masks/yabing-tudi/side.png", back: "/dream-assets/codex/masks/yabing-tudi/back.png" }, artwork: { card: "/dream-assets/ui/codex/fronts/yabing-tudi-v2.png" }, themes: ["工作", "事业", "同辈", "比较", "位置", "边界", "价值"], visual: { tint: "iron", pattern: "衡纹", emblem: "尺印", card: { primary: "#c99b3d", secondary: "#6f847b", glyph: "scale" }, relief: { depth: 0.28, resolution: 56, threshold: 24 } } },
    { id: "high-crown", name: "唐氏太婆", asset: "/dream-assets/codex/masks/tangshi-taipo/front.png", views: { front: "/dream-assets/codex/masks/tangshi-taipo/front.png", side: "/dream-assets/codex/masks/tangshi-taipo/side.png", back: "/dream-assets/codex/masks/tangshi-taipo/back.png" }, artwork: { card: "/dream-assets/ui/codex/fronts/tangshi-taipo-v2.png" }, themes: ["否定", "自我", "评价", "失去", "重建", "不安", "找回"], visual: { tint: "bone", pattern: "回纹", emblem: "灯印", card: { primary: "#c99b3d", secondary: "#88aa97", glyph: "lamp" }, relief: { depth: 0.26, resolution: 56, threshold: 24 } } },
    { id: "gou-bu-pan-guan", name: "勾簿判官", asset: "/dream-assets/ui/codex/details/gou-bu-pan-guan/main-mask.png", views: { front: "/dream-assets/ui/codex/details/gou-bu-pan-guan/main-mask.png", side: "/dream-assets/codex/masks/gou-bu-pan-guan/side.png", back: "/dream-assets/codex/masks/gou-bu-pan-guan/back.png" }, artwork: { card: "/dream-assets/ui/codex/fronts/gou-bu-pan-guan-v3.png" }, themes: ["归魂", "归档", "名字", "旧事", "责任", "亏欠", "身份"], visual: { tint: "vermilion", pattern: "朱笔", emblem: "簿印", card: { primary: "#c99b3d", secondary: "#7f6255", glyph: "lamp" }, relief: { depth: 0.30, resolution: 56, threshold: 24 } } },
    { id: "sao-di-he-shang", name: "扫地和尚", asset: "/dream-assets/ui/codex/details/sao-di-he-shang/main-mask.png", views: { front: "/dream-assets/ui/codex/details/sao-di-he-shang/main-mask.png", side: "/dream-assets/codex/masks/sao-di-he-shang/side.png", back: "/dream-assets/codex/masks/sao-di-he-shang/back.png" }, artwork: { card: "/dream-assets/ui/codex/fronts/sao-di-he-shang-v6.png" }, themes: ["扫余", "结束", "放下", "余响", "旧灰", "清理", "遗憾"], visual: { tint: "earth", pattern: "尘环", emblem: "扫印", card: { primary: "#c99b3d", secondary: "#9a8060", glyph: "mountain" }, relief: { depth: 0.24, resolution: 56, threshold: 24 } } },
    { id: "liu-yi", name: "柳毅", asset: "/dream-assets/ui/codex/details/liu-yi/main-mask.png", views: { front: "/dream-assets/ui/codex/details/liu-yi/main-mask.png", side: "/dream-assets/codex/masks/liu-yi/side.png", back: "/dream-assets/codex/masks/liu-yi/back.png" }, artwork: { card: "/dream-assets/ui/codex/fronts/liu-yi-v2.png" }, themes: ["沟通", "求助", "传递"], visual: { tint: "ink", pattern: "书信纹", emblem: "信印", card: { primary: "#c99b3d", secondary: "#687879", glyph: "knot" }, relief: { depth: 0.26, resolution: 56, threshold: 24 } } },
    { id: "abu-mo", name: "阿布摩", asset: "/dream-assets/ui/codex/details/abu-mo/main-mask.png", views: { front: "/dream-assets/ui/codex/details/abu-mo/main-mask.png", side: "/dream-assets/codex/masks/abu-mo/side.png", back: "/dream-assets/codex/masks/abu-mo/back.png" }, artwork: { card: "/dream-assets/ui/codex/fronts/abu-mo-v2.png" }, themes: ["留种", "延续", "灾后", "未来", "荒年", "种子", "重启"], visual: { tint: "charcoal", pattern: "白波", emblem: "种印", card: { primary: "#c99b3d", secondary: "#8b8170", glyph: "scale" }, relief: { depth: 0.22, resolution: 56, threshold: 24 } } }
  ],
  story: [
  ...
  roles: [
    ...
    { id: "message-bearer", name: "柳毅", duty: "传声", maskIndex: 6, kind: "traditional_reference", triggers: ["沟通", "求助", "传递"], choiceWeights: [1, 1, 1], signs: ["方巾", "长髭", "书信"], background: "《柳毅传书》中承担传信之责的书生形象。", sources: ["gz-cppcc-nuo"], reason: "让受阻的声音抵达能够回应的人。" },
    { id: "seed-keeper", name: "阿布摩", duty: "在失序之后保存未来", maskIndex: 7, kind: "traditional_reference", triggers: ["留种", "延续", "灾后", "未来"], choiceWeights: [1, 1, 1], signs: ["黑木", "白波", "种袋"], background: "威宁彝族撮泰吉阿布摩的灾后复耕形象。", sources: ["gz-cppcc-nuo"], reason: "不要求世界立刻复原，只先把下一季的种子留下。" }
  ],
  sources: [
